...
execute as @n[tag=lobby.minigame.slot.1] if score @s bf matches 7 at @s run function lobby:minigame/slot/summon {num:1}
execute as @n[tag=lobby.minigame.slot.2] if score @s bf matches 7 at @s run function lobby:minigame/slot/summon {num:2}
execute as @n[tag=lobby.minigame.slot.3] if score @s bf matches 7 at @s run function lobby:minigame/slot/summon {num:3}
