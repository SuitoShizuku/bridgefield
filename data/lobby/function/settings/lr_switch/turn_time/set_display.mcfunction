...
execute if score $turn_time_sec bf matches ..59 run return run data modify entity @s text set value [{translate:"bf.second",fallback:"%s秒",with:[{score:{name:"$turn_time_sec",objective:"bf"}}]}]
