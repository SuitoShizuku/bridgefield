...
execute if score $max_teams bf matches 2..7 as @n[tag=fence_motion.white] at @s positioned ~ ~ ~3 run tp @a[dx=2,dz=2,dy=2] ~1 1.0 0
execute if score $max_teams bf matches 2..6 as @n[tag=fence_motion.cyan] at @s positioned ~ ~ ~-3 run tp @a[dx=2,dz=2,dy=2] ~1 1.0 0
execute if score $max_teams bf matches 2..5 as @n[tag=fence_motion.pink] at @s positioned ~ ~ ~3 run tp @a[dx=2,dz=2,dy=2] ~1 1.0 0
execute if score $max_teams bf matches 2..4 as @n[tag=fence_motion.orange] at @s positioned ~ ~ ~-3 run tp @a[dx=2,dz=2,dy=2] ~1 1.0 0
execute if score $max_teams bf matches 2..3 as @n[tag=fence_motion.green] at @s positioned ~ ~ ~3 run tp @a[dx=2,dz=2,dy=2] ~1 1.0 0
execute if score $max_teams bf matches 2 as @n[tag=fence_motion.yellow] at @s positioned ~ ~ ~-3 run tp @a[dx=2,dz=2,dy=2] ~1 1.0 0