...
execute as @e[type=text_display,tag=iv.text.right] if score $button.interval.right iv matches 0 if data entity @s {text:{"text":"Next",color:"red"}} run data merge entity @s {text:{"text":"Next",color:"white"}}
execute as @e[type=text_display,tag=iv.text.left] if score $button.interval.left iv matches 0 if data entity @s {text:{"text":"Back",color:"red"}} run data merge entity @s {text:{"text":"Back",color:"white"}}
