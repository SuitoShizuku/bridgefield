...
execute if score $button.interval.right.timer iv matches 5.. run setblock -22 2 -5 warped_button[face=floor,facing=north]
execute if score $button.interval.left.timer iv matches 5.. run setblock -24 2 -5 crimson_button[face=floor,facing=north]

execute if score $button.interval.right.timer iv matches 5.. run scoreboard players set $button.interval.right.timer iv 0
execute if score $button.interval.left.timer iv matches 5.. run scoreboard players set $button.interval.left.timer iv 0
