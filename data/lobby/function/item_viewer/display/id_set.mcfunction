...
data merge entity @n[type=minecraft:text_display,tag=iv.text.id] {text:[{score:{objective:"iv",name:"$item.id"},color:"gray"},{"text":"/",color:"black"},{score:{objective:"iv",name:"$item.id.max"},color:"dark_gray"}]}