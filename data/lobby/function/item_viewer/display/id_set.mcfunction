...
execute if data storage bf:iv name.fallback run return run function lobby:item_viewer/display/text_display/id_macro with storage bf:iv
function lobby:item_viewer/display/text_display/id_macro_default_item with storage bf:iv