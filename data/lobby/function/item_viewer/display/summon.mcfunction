...
#block_display召喚
summon minecraft:item_display -23.0 6 -5.5 {Tags:["iv","down"],teleport_duration:5,transformation:{translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[0.5f,0.5f,0.5f]},item:{id:"minecraft:ochre_froglight"},Rotation:[-45f,0f]}
summon minecraft:item_display -22.0 5.7 -5.5 {Tags:["iv","down"],teleport_duration:5,transformation:{translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[0.3f,0.3f,0.3f]},item:{id:"minecraft:ochre_froglight"},Rotation:[-65f,0f]}
#interaction召喚
