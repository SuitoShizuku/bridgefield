...
summon minecraft:text_display -22 0.5 -6 {Tags:["iv","iv.text.next"],teleport_duration:5,text:{"text":"Next"}}
summon minecraft:text_display -23.5 0.5 -6 {Tags:["iv","iv.text.back"],teleport_duration:5,text:{"text":"Back"}}
