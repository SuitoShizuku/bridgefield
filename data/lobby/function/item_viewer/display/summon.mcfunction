...
#block_display召喚
summon minecraft:block_display -24.0 6 -6.0 {Tags:["iv","down"],teleport_duration:5,transformation:{translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[0.5f,0.5f,0.5f]},block_state:{Name:"minecraft:ochre_froglight"},Rotation:[-45f,0f]}
summon minecraft:block_display -23.0 5.5 -6.0 {Tags:["iv","down"],teleport_duration:5,transformation:{translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[0.2f,0.2f,0.2f]},block_state:{Name:"minecraft:ochre_froglight"},Rotation:[-65f,0f]}
#interaction召喚
