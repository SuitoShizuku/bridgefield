...
#block_display召喚
summon minecraft:block_display -23.5 5 -5.5 {Tags:["iv","down"],teleport_duration:5,transformation:{translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[0.7f,0.7f,0.7f]},block_state:{Name:"minecraft:ochre_froglight"}}
#interaction召喚
