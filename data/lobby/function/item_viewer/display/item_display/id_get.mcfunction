...
execute if score $item.id iv matches 9 run data merge storage bf:iv {id:"minecraft:leather_helmet",name:"[護]革の帽子",lore:"装備アイテム",defence:1}
execute if score $item.id iv matches 10 run data merge storage bf:iv {id:"minecraft:leather_chestplate",name:"[護]革のジャケット",lore:"装備アイテム",defence:3}
execute if score $item.id iv matches 11 run data merge storage bf:iv {id:"minecraft:leather_leggings",name:"[護]革のズボン",lore:"装備アイテム",defence:2}
