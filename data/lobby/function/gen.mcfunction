...
# アイテムビューワー
summon minecraft:text_display -23 5 -4.0 {Tags:["lobby"],teleport_duration:5,text:{"text":"Item Viewer",color:"white"},transformation:{translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[2f,2f,2f]},background:-16777216}