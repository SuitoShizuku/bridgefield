...
$tellraw @s [{"translate":"bf.chat.add_defense",fallback:"防御力%1$s → %2$s (装備%3$s層)",with:[{text:"+$(armorDefense)",color:"gray"},{score:{name:"@s",objective:"defense"},color:"gray"},{"score":{name:"@s",objective:"armor_count"}}]}]
