execute unless score $totalDMG bf matches 1.. run return run tellraw @p[tag=true_turn,tag=!blindness] [{translate:"bf.chat.effect.fail",fallback:"%sの付与 - 失敗",with:[{text:"§9凍傷"}]}]
