...
tag @s add placed
execute at @n[type=interaction,tag=game.interact.bridge,tag=east,nbt={interaction:{}}] positioned ~ ~4 ~-3 run function core:bridge/place/duravility_count with entity @s SelectedItem.components."minecraft:custom_data"
