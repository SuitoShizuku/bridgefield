...
scoreboard objectives add rank.ranking dummy "ランキング"
scoreboard objectives add rd.settings.notification.levelup dummy "設定 レベルアップ通知"
scoreboard objectives add rd.settings.notification.xp_get dummy "設定 経験値獲得通知"
scoreboard objectives add rd.settings.trigger trigger "設定 トリガー"