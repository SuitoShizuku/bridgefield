fill 111 1 338 139 20 346 air
place template core:map/6/destroy/b3 111 1 338 none
...
kill @e[tag=game.interact.bridge,sort=nearest,limit=4,distance=..5,type=interaction]
