...
place template core:map/1/island_5 ~-12 ~16 ~-12
place template core:map/1/island_3 ~-2 ~16 ~-12
place template core:map/1/island_7 ~8 ~16 ~-12

place template core:map/1/island_1 ~-12 ~16 ~-2
place template core:map/1/island_c ~-2 ~16 ~-2
place template core:map/1/island_2 ~8 ~16 ~-2

place template core:map/1/island_8 ~-12 ~16 ~8
place template core:map/1/island_4 ~-2 ~16 ~8
place template core:map/1/island_6 ~8 ~16 ~8
